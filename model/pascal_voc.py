...
class PascalVocGenerator(Generator):
    ...
    def __parse_annotation(self, element):
        ...
        if class_name not in self.classes:
            raise ValueError('La classe \'{}\' non è tra le classi disponibili: {}'.format(class_name, list(self.classes.keys())))
    ...
    def __parse_annotations(self, xml_root):
        ...
        for i, element in enumerate(xml_root.iter('object')):
            try:
                ...
                raise_from(ValueError('Non è possibile interpretare l\'oggetto #{}: {}'.format(i, e)), None)
    ...
    def load_annotations(self, image_index):
        ...
        try:
            ...
            raise_from(ValueError('File di annotazione non valido: {}: {}'.format(filename, e)), None)
        except ValueError as e:
            raise_from(ValueError('File di annotazione non valido: {}: {}'.format(filename, e)), None)
